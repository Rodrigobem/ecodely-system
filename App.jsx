                            ...
                            <div key={gi}>
                              {grupo.lancs.map((l,i)=>{const rowBg=l.confirmado?"#d4edda":l.tipo==="Saldo Anterior"?"#f0e8ff":i%2===0?"#fff":"#f2f6fc";return(
                                <div key={l.id||i} style={{display:"grid",gridTemplateColumns:colWidths.map(w=>w+"px").join(" "),gap:0,borderBottom:"1px solid #888",background:rowBg,alignItems:"stretch",cursor:"pointer"}} onClick={()=>setEditLanc({...l})}>
                                  ...
                                  <div data-col="2" style={{fontFamily:"Arial,sans-serif",fontSize:11,color:"#16a34a",fontWeight:700,textAlign:"right",padding:"7px 10px",borderRight:"1px solid #888",whiteSpace:"nowrap",background:rowBg,display:"flex",alignItems:"center",justifyContent:"flex-end",borderBottom:"1px solid #888"}}>{l.entrada>0?fmt(l.entrada):""}</div>
                                  <div data-col="3" style={{fontFamily:"Arial,sans-serif",fontSize:11,color:"#dc2626",fontWeight:700,textAlign:"right",padding:"7px 10px",borderRight:"1px solid #888",whiteSpace:"nowrap",background:rowBg,display:"flex",alignItems:"center",justifyContent:"flex-end",borderBottom:"1px solid #888"}}>{l.saida>0?fmt(l.saida):""}</div>
                                  <div style={{borderRight:"1px solid #888",borderBottom:"1px solid #888",minHeight:38,background:rowBg,alignSelf:"stretch"}}/><div style={{borderRight:"1px solid #888",borderBottom:"1px solid #888",minHeight:38,background:rowBg,alignSelf:"stretch"}}/><div style={{borderRight:"1px solid #888",borderBottom:"1px solid #888",minHeight:38,background:rowBg,alignSelf:"stretch"}}/>
