                            ...
                            <div key={gi}>
                              {grupo.lancs.map((l,i)=>{const rowBg=l.confirmado?"#d4edda":l.tipo==="Saldo Anterior"?"#f0e8ff":i%2===0?"#fff":"#f2f6fc";return(
                                <div key={l.id||i} style={{display:"grid",gridTemplateColumns:colWidths.map(w=>w+"px").join(" "),gap:0,background:rowBg,alignItems:"stretch",cursor:"pointer"}} onClick={()=>setEditLanc({...l})}>
                                  <div data-col="0" style={{fontSize:10,color:"#444",fontFamily:"Arial,sans-serif",padding:"7px 10px",overflow:"hidden",whiteSpace:"nowrap",background:rowBg,display:"flex",alignItems:"center",boxShadow:"inset -1px -1px 0 #888"}}>{l.tipo==="Saldo Anterior"?"":l.data.slice(0,5)}</div>
                                  ...
                                  <div data-col="2" style={{fontFamily:"Arial,sans-serif",fontSize:11,color:"#16a34a",fontWeight:700,textAlign:"right",padding:"7px 10px",whiteSpace:"nowrap",background:rowBg,display:"flex",alignItems:"center",justifyContent:"flex-end",boxShadow:"inset -1px -1px 0 #888"}}>{l.entrada>0?fmt(l.entrada):""}</div>
                                  <div data-col="3" style={{fontFamily:"Arial,sans-serif",fontSize:11,color:"#dc2626",fontWeight:700,textAlign:"right",padding:"7px 10px",whiteSpace:"nowrap",background:rowBg,display:"flex",alignItems:"center",justifyContent:"flex-end",boxShadow:"inset -1px -1px 0 #888"}}>{l.saida>0?fmt(l.saida):""}</div>
                                  <div style={{minHeight:38,background:rowBg,alignSelf:"stretch",boxShadow:"inset -1px -1px 0 #888"}}/><div style={{minHeight:38,background:rowBg,alignSelf:"stretch",boxShadow:"inset -1px -1px 0 #888"}}/><div style={{minHeight:38,background:rowBg,alignSelf:"stretch",boxShadow:"inset -1px -1px 0 #888"}}/>
                              ...
                              <div style={{borderTop:"2px solid #555",borderBottom:"2px solid #555"}}><div style={{display:"grid",gridTemplateColumns:colWidths.map(w=>w+"px").join(" "),gap:0,alignItems:"stretch"}}>
                                <div style={{fontSize:9,color:"#2d6a4f",fontFamily:"Arial,sans-serif",fontWeight:700,padding:"6px 10px",background:"#d4edda",display:"flex",alignItems:"center",boxShadow:"inset -1px -1px 0 #888"}}>{grupo.data.slice(0,5)}</div>
                                <div style={{fontSize:9,color:"#2d6a4f",fontWeight:800,textTransform:"uppercase",letterSpacing:1,padding:"6px 10px",background:"#d4edda",display:"flex",alignItems:"center",boxShadow:"inset -2px -1px 0 #888"}}>Saldo do período</div>
                                <div style={{background:"#d4edda",minHeight:32,boxShadow:"inset -1px -1px 0 #888"}}/>
                                <div style={{background:"#d4edda",minHeight:32,boxShadow:"inset -1px -1px 0 #888"}}/>
                                <div style={{fontFamily:"Arial,sans-serif",fontSize:11,color:"#16a34a",fontWeight:800,textAlign:"right",padding:"6px 10px",background:"#d4edda",display:"flex",alignItems:"center",justifyContent:"flex-end",boxShadow:"inset -1px -1px 0 #888"}}>{dEntradas>0?fmt(dEntradas):""}</div>
                                <div style={{fontFamily:"Arial,sans-serif",fontSize:11,color:"#dc2626",fontWeight:800,textAlign:"right",padding:"6px 10px",background:"#d4edda",display:"flex",alignItems:"center",justifyContent:"flex-end",boxShadow:"inset -1px -1px 0 #888"}}>{dSaidas>0?fmt(dSaidas):""}</div>
                                <div style={{fontFamily:"Arial,sans-serif",fontSize:13,fontWeight:800,color:saldoDia>=0?"#16a34a":"#dc2626",textAlign:"right",padding:"6px 10px",background:"#d4edda",boxShadow:"inset -1px -1px 0 #888",display:"flex",alignItems:"center",justifyContent:"flex-end"}}>{fmt(saldoDia)}</div>
